      ...
      <div className="tabletop-container">
        ...
        <section className="tabletop-philosophy-section">
          ...
          <div className="philosophy-image">
            <img
              src="/images/tabletop-philosophy.jpg"
